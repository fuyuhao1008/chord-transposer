...
| 2 | 多模态Agent模型 | 支持视觉，通用能力强 | `doubao-seed-1-8-251228` |
| 3 | 其他模型 | 支持视觉的其他模型 | `doubao-seed-1-6-thinking-250715` |
...
| `doubao-seed-1-8-251228` | 多模态Agent | 2 | 支持视觉，推荐作为备用 |
| `doubao-seed-1-6-251015` | 平衡性能 | 2 | 支持多模态，可作为备选 |
| `doubao-seed-1-6-thinking-250715` | 深度推理 | 3 | 支持视觉，紧急备用 |
| `doubao-seed-1-6-flash-250615` | 快速响应 | 3 | 支持视觉，紧急备用 |

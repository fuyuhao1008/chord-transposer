...
function CalibrationMarker({
  ...
  const textLines = isFirst
    ? ['请长按此文本框并拖动', '使红点落在第一个和弦标记中央', '(必须是最上方的和弦)']
            ...
            <Card className="w-full max-w-4xl !p-0 !py-0 !gap-0">
              ...
              <div className="mb-1 mx-6 bg-indigo-600 text-white px-6 py-3 rounded-lg text-center font-semibold shadow-lg animate-pulse">
                {pageState === 'locating_first'
                  ? (isMobile
                      ? <><div>请点击【第一个】和弦标记</div><div className="mt-1 font-normal text-red-300">（必须是最上方的和弦）</div><div className="mt-1 font-normal text-red-300">（可双指划开图片进行放大）</div></>
                      : <><div>请点击【第一个】和弦标记</div><div className="mt-1 font-normal text-red-300">（必须是最上方的和弦）</div></>)
                  : (isMobile
